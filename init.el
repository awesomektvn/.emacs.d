...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (blackboard-theme git-gutter helm-descbinds magit powerline projectile yasnippet web-mode use-package multiple-cursors helm-ls-git expand-region bookmark+ auto-complete ace-jump-mode))))
(custom-set-faces
